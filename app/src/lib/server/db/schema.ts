...
// Provider configurations for multi-provider LLM support
export const providerConfigs = pgTable('provider_configs', {
  id: text('id').primaryKey().$defaultFn(() => crypto.randomUUID()),
  providerId: text('provider_id').notNull(), // 'anthropic', 'openai', 'google', 'openrouter', 'openai-compatible'
  apiKey: text('api_key'), // Encrypted
  baseUrl: text('base_url'), // For OpenAI-compatible providers
